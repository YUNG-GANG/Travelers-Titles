...
//
////        Pair<BlockPos, Holder<Biome>> pair = commandSource.getLevel().findNearestBiome(biomeResult, new BlockPos(commandSource.getPosition()), 6400, 8);
////        if (pair == null) {
////            throw BIOME_NOT_FOUND_EXCEPTION.create(biomeResult.asPrintable());
////        } else {
////            return LocateCommand.showLocateResult(commandSource, biomeResult, new BlockPos(commandSource.getPosition()), pair, "commands.locatebiome.success");
////        }
//
