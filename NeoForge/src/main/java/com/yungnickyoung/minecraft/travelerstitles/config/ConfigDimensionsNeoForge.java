...
public class ConfigDimensionsNeoForge {
    ...
    public final ModConfigSpec.ConfigValue<String> dimensionBlacklist;
    ...
    public ConfigDimensionsNeoForge(final ModConfigSpec.Builder BUILDER) {
        BUILDER
            .comment(
                "##########################################################################################################\n" +
